...
import { Package, FileUp, ChevronRight } from "lucide-react";
...
export default function DeviceManagement() {
  ...
  // Define device management options
  const deviceOptions = [
    {
      title: "Devices",
      description: "View and manage all devices in the system",
      icon: Package,
      url: "/devices",
    ...
    },
    {
      ...
      description: "Bulk import devices from CSV/Excel files",
      icon: FileUp,
      url: "/device-import",
        ...
        <Card className="max-w-md">
          <div className="pt-6 pb-6 text-center px-6">
            ...
            <p className="text-muted-foreground">
              Only administrators can access device management features.
            </p>
          </div>
        </Card>
      </div>
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-2">
          Manage devices, imports, and device data
        </p>
      </div>
